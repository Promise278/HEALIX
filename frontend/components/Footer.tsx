...
function Footer() {
  ...
  // Hide footer on professional dashboards and chat pages
  const isDashboardPage = 
    pathname?.startsWith("/pages/dashboard") || 
    pathname?.startsWith("/pages/docsdashboard") || 
  ...
  return (
    <>
      <div>
        <section className="py-20 bg-linear-to-r from-[#17a8ce] to-[#2bbfb5] relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-lg text-primary-foreground/90 mb-8 max-w-2xl mx-auto">
              Join thousands of patients who trust HEALIX for their healthcare
              needs
            </p>
            {!(
              pathname === "/pages/home" ||
              pathname === "/pages/doctors" ||
