            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8 animate-fade-in">
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <button className="border cursor-pointer border-[#12a7d7] text-[#12a7d7] w-38 h-12 rounded-md">
                    Get Started
                  </button>
                </div>
                <div className="flex items-center gap-8 pt-4">
                  <div>
                    <div className="text-3xl font-bold text-[#12a7d2]">
                      500+
                    </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-white border-gray-200">
                ...
                <p className="text-gray-600">
                  Face-to-face consultations with doctors through secure HD
                  video calls
                </p>
              </Card>
              ...
              <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-white border-gray-200">
                ...
                <p className="text-gray-600">
                  Book appointments that fit your schedule with just a few
                  clicks
                </p>
              </Card>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Browse our network of qualified doctors and select the one
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600">
                  Connect via video or chat for your consultation and receive
                  care
                </p>
              </div>
            </div>
